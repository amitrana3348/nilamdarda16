...
#################################################################################################
############################ GPIO DECLARATIONS FOR PIR and GAS SENSORS LIGHT SENSOR and LCD ##########################
pir = 27
...
############################################################################################
########################  GPIO DECLARATIONS FOR RELAY AND LED ##############################
...
def hello():
    ...
    text_file.write(timeString + str(temperature) + str(humidity) + str(1) + str(lux) + str(1) + '\n\r\r\n')
    text_file.write("\r")
    text_file.close()
    csvfile = open("SENS.csv","a")
    csvfile.write(timeString + str(temperature) + str(humidity) + str(1) + str(lux) + str(1) + '\n\r\r\n')
    csvfile.close()
    templateData = {
	'title' : 'HELLO!',
	'time' : timeString,
	...
	'pirsens' : pirsens,
	'lgt' : luxread,
	'lpg' : gassens #this is ultrasonic sensor value
	}
